          ...
          <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-non block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none  focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
...
{/* password */}
            ...
            <div>
                ...
                <div className="mt-2 flex items-center">
                    ...
                    <label htmlFor="file-input" className="ml-5 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray">
...
{/* submit button */}
            ...
            <div className={`${styles.noramlFlex} w-full`}>
              ...
              <Link to="/login" className="text-blue-600 pl-2 hover:text-blue-500">Sign In</Link>
